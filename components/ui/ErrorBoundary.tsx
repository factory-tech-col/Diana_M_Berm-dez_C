    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4" role="alert" aria-live="assertive">
          <h2 className="text-3xl font-serif text-[#1C1C1C] mb-4">Algo salió mal.</h2>
          <p className="text-gray-600 mb-8 max-w-md">
            Lamentamos el inconveniente. Por favor, actualice la página o contáctenos si el problema persiste.
          </p>
          <button
